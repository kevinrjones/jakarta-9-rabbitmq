...
public class ProducerTest {
    ...
    public void testPublishMessage() throws IllegalAccessException {
        ...
        assertThat(name)
                .withFailMessage("==> Have you created a `private final static String EXCHANGE_NAME` feld with the value `direct` in the `Consumer` class.")
                .isEqualTo("fanout_exchange");
        nameField.setAccessible(true);
