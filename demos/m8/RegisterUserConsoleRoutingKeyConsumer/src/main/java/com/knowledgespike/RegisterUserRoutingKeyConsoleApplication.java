...
public class RegisterUserRoutingKeyConsoleApplication {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        var consumerUserRegistration1 = new ConsumeUserRegistrationWithRoutingKey(connection, "direct-queue", "direct-route");

        consumerUserRegistration1.consumeMessage(deliverCallback, cancelCallback);

        var consumerUserRegistration2 = new ConsumeUserRegistrationWithRoutingKey(connection, "direct-queue", "another-direct-route");
