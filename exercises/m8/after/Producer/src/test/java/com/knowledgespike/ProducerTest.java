...
public class ProducerTest {
    ...
    public void testDeclareExchange() throws IllegalAccessException {
        ...
        assertThat(name)
                .withFailMessage("==> Have you created a `private final static String EXCHANGE_NAME` field with the value `topic-exchange` in the `Producer` class.")
                .isEqualTo("topic-exchange");
        nameField.setAccessible(true);
